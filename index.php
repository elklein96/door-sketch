...
<body>
    <div class="container">
        <div id="page-wrapper">
            <br>
            <canvas id="colors_sketch" width="230" height="456" style="position:absolute; top:50%; left:50%; background: url(img/door.jpg) no-repeat center center;"></canvas>
            <div class="tools" style="position:absolute; top:50%; left:50%; ">
